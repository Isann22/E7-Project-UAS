...
@section('content')
    <div class="container">
        ...
        <h1>Daftar Tiket</h1>
        <button class="btn btn-primary mb-3" data-toggle="modal" data-target="#createTicketModal">Tambah Tiket</button>
        @if ($tickets->count())
            <table class="table">
                <thead>
                    <tr>
                    ...
                    @foreach ($tickets as $ticket)
                        <tr>
                            ...
                            <td>
                                ...
                                <form action="{{ route('organizer.tickets.destroy', $ticket->id) }}" method="POST"
                        ...
                        <!-- View Modal -->
                        <div class="modal fade" id="viewTicketModal{{ $ticket->id }}" tabindex="-1" role="dialog"
                            aria-labelledby="viewTicketModalLabel{{ $ticket->id }}" aria-hidden="true">
                            <div class="modal-dialog" role="document">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <h5 class="modal-title" id="viewTicketModalLabel{{ $ticket->id }}">Detail Tiket
                                        </h5>
                        ...
                        <div class="modal fade" id="editTicketModal{{ $ticket->id }}" tabindex="-1" role="dialog"
                            ...
                            <div class="modal-dialog" role="document">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <h5 class="modal-title" id="editTicketModalLabel{{ $ticket->id }}">Edit Tiket
                                        </h5>
                                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                            <span aria-hidden="true">&times;</span>
                                        </button>
