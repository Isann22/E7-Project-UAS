        ...
        <section class="fitur text-light " style='margin-top: 100px;'>
            ...
            <div class="games-grid mt-2">
             ...
             <section class="text-light text-center mt-5 mb-5">
                <h3 style="font-size: 1.5rem;"><b>Temukan pemain terbaik untuk timmu dan menangkan setiap pertandingan!</b></h3>
                <p style="font-size: 1.5rem;">Dengan pemain yang tepat, kamu bisa menguasai setiap pertandingan dan mencapai puncak kejayaan.</p>
                <p style="font-size: 1.5rem;">Jangan ragu untuk memilih pemain yang sesuai dengan strategi dan gaya bermain timmu.</p>
                <p style="font-size: 1.5rem;">Setiap pemain memiliki keahlian unik yang bisa memberikan keuntungan besar dalam turnamen.</p>
            </section>
    
            <section class=" text-light project-highlight mt-5 mb-5">
                <div class="project-content">
                    <h2 class="mt-3"><b>Raih Kemenangan Bersama Tim Tebaikmu!</b></h2>
                    <p class="mt-3 mb-3 half-width">Bergabunglah dengan komunitas pemain terbaik dan buktikan kemampuanmu di arena turnamen. 
            ...
            <section class="text-light recent-projects mt-5 mb-5">
                ...
                <p class="mt-3 mb-5" align="center">Tim ini telah bekerja keras dan berlatih tanpa henti untuk mencapai puncak kejayaan. 
                Dengan semangat juang yang tinggi dan strategi yang matang, mereka siap menghadapi setiap tantangan dan meraih kemenangan.</p>
